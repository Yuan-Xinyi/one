...
### 1. 只围绕优势组织论文
优先寻找本文真正领先、独特或不可替代的部分，包括新能力、新问题、新机制、新视角、更强适用性、更低成本、更高效率、更好扩展性或更有意义的权衡。
没有形成优势的内容，不应成为论文主线。

### 2. 不要写成工作汇报
不要按照"我们先做了什么、后来尝试了什么、哪些尝试失败了"的过程展开。
论文只保留最终成立的逻辑：问题为什么重要，现有方法为什么不够，本文提供了什么新解法，证据如何支持这一解法。
...
重新定义论文真正解决的问题，重新排序贡献，重新选择主结果，重新设计标题、摘要、引言和实验结构。
...
### 12. 结论只强化记忆点
结论不是重新审判论文，而是让读者记住：本文解决了什么、提出了什么、证明了什么、为什么重要。
