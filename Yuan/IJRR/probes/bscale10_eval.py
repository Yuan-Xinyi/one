...
hl.SUB = 2
y = yaml.safe_load(open(REPO / 'Yuan/IJRR/stage2_traj/config_vertex_line_bscale10.yaml'))
...
model.terms = [0, 1]
ag = _agent(REPO / 'Yuan/IJRR/runs/rl_vertex_line_bscale10_30M', env.obs_dim,
...
for lo in range(0, N, B):
    ...
    print(f'[bscale10 vlook] {hi}/{N} mean {out[:hi].mean():.4f}', flush=True)
np.savez('/home/lqin/one/Yuan/IJRR/runs/paper_fill/fam_unify/'
         'bscale10_vlook_10k.npz', prog=out)
