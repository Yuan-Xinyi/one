...
model.terms = [0, 1]
ag = _agent(REPO / 'Yuan/IJRR/runs/rl_vertex_line_q7rand_30M', env.obs_dim,
...
for lo in range(0, N, B):
    ...
    print(f'[q7rand vlook] {hi}/{N} mean {out[:hi].mean():.4f}', flush=True)
np.savez('/home/lqin/one/Yuan/IJRR/runs/paper_fill/fam_unify/'
         'q7rand_vlook_10k.npz', prog=out)
