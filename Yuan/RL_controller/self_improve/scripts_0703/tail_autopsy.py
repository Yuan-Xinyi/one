...
OUT = Path('/home/lqin/one/Yuan/RL_controller/runs/distill_r12m_b0.965_soup2/tail_autopsy.npz')

d = np.load(SW / 'main_r12m965+switch0.985-0.96.npz')
pct, bucket = d['pct'], d['bucket']
