...
Usage:
    python -m Yuan.seed_selection.eval.viz_inference --ckpt path/to/step_N.pt \\
...
_DEFAULT_CKPT = _REPO_ROOT / "Yuan/seed_selection/runs/pilot_20k/q0_20k_cfg_mirror_ckpts/step_300000.pt"
_DEFAULT_DATA = _REPO_ROOT / "Yuan/seed_selection/runs/pilot_20k/pilot_20k.npz"
