...
OUT = Path('Yuan/seed_selection/runs/fresh_holdout')
OUT.mkdir(parents=True, exist_ok=True)
N_FRESH = 2048
CKPT_NEW = Path('Yuan/RL_controller/runs/distill_r12m_b0.965_soup2')
TAU_NEW = (0.985, 0.96)
...
# ---- 4. ranker pick ----
ck = torch.load('Yuan/seed_selection/runs/rank_train/ranker_v4.pt',
