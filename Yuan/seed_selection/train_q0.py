...
ckpt dir. Same split is reused on resume and by `eval_q0.py`.

Usage:
    python -m Yuan.seed_selection.train_q0
    python -m Yuan.seed_selection.train_q0 --resume .../step_20000.pt --num-steps 50000
"""
